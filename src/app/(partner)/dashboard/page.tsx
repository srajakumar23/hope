        ...
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 items-stretch">
                {metrics.map((m, idx) => (
                    <motion.div key={idx} variants={item} className="h-full">
                        <Card className="h-full hover:shadow-2xl hover:shadow-gray-200/50 hover:-translate-y-1.5 transition-all duration-500 border-none bg-white cursor-default group">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
                <motion.div variants={item} className="lg:col-span-2 h-full">
                    <Card className="border-none h-full bg-white shadow-xl shadow-gray-200/50">
                        <CardHeader>
