...
export default function PassDisplayPage({ params }: { params: Promise<{ guestId: string }> }) {
    ...
    const [guestData, setGuestData] = useState<{ name: string, mobile: string, partnerName: string, partnerCode: string, commissionSlab: number } | null>(null);
